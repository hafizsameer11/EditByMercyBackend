...
class FirebaseNotificationService
{
    ...
    {
        $this->fcmUrl = 'https://fcm.googleapis.com/v1/projects/mercynative-769ea/messages:send';
        $this->credentialsPath = storage_path('app/json/service-mercy.json'); // Path to your Service Account key
        $this->projectId = 'mercynative-769ea'; // Ensure you set this in your config/services.php
    }
